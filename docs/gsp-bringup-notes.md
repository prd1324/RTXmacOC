...
> ✅ **СЛОЙ 2 РЕШЁН на железе 2026-06-30** (`GSP_INIT_DONE` по RPC). Этот документ —
> исходный ПЛАН. Фактическая РАБОЧАЯ реализация со всеми деталями и граблями —
> **`docs/gsp-bringup-layer2.md`** (читать его при работе по слою 2).
>
